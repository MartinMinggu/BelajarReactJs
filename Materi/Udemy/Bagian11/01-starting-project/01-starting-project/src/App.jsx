...
function App() {
  ...
  useEffect(() => {
    navigator.geolocation.getCurrentPosition((lokasiSekarang) => {
      const sortedPlaces = sortPlacesByDistance(AVAILABLE_PLACES, lokasiSekarang.coords.latitude, lokasiSekarang.coords.longitude)
  ...
  function handleSelectPlace(id) {
    ...
    // console.log("stored places : " + storedIds);
